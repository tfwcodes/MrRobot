...
while True:
    try:
        ...
        if menu_help == "6":
            try:
                print("\n" + Fore.BLUE + "[20] Password Manager" + "\n" + Fore.BLUE + "[21] Spam-app" + "\n" + Fore.BLUE + "[22] Simple-Timer" + "\n" + Fore.BLUE + "[23] GUI Timer" + "\n")
        ...
        if menu_help == "5":
            try:
                while True:
                    print("\n" + Fore.BLUE + "[18] Deauthentication Attack" + "\n" + Fore.BLUE + "[19] WPA2 Cracker"  )
                    print("\n" + Fore.BLUE + "[!!!] To run any tool from here you must run linux" + "\n")
